...
export const NOTICE = 'border-[3px] border-ink bg-yellow px-4 py-3 text-sm font-bold text-ink'
...
/** 분류 칩 — 노랑 네모. */
export const CHIP = 'inline-flex items-center border-[3px] border-ink bg-yellow px-2 py-0.5 text-xs font-bold text-ink'
