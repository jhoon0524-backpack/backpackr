...
import { BTN_SECONDARY, CHIP } from '@/app/ui'
        ...
        <div>
          ...
          <section className="mt-8 border-t border-line pt-6">
            ...
            <ol className="mt-3 space-y-2 text-[15px] leading-relaxed text-strong">
              <li><span className="num mr-2 font-bold text-accent-deep">1</span>의뢰 내용을 보내면 창작자가 확인합니다. 보내는 것은 무료입니다.</li>
              <li><span className="num mr-2 font-bold text-accent-deep">2</span>창작자가 최종가를 정해 수락하면 그날부터 {c.turnaround_days}일 안에 작업합니다.</li>
              <li><span className="num mr-2 font-bold text-accent-deep">3</span>결과물을 전달받고 확인하면 완료됩니다.</li>
            </ol>
          </section>
        </div>
          ...
          <div className="rounded-lg border border-line p-6">
            <dl className="space-y-4">
              ...
              <div className="flex gap-8">
                ...
                <div>
                  <dt className="text-sm text-muted">남은 자리</dt>
                  <dd className="mt-1 text-xl">
                    <SlotText active={c.active_count} max={c.max_slots} status={c.status} />
                    <span className="num ml-1 text-sm text-muted">/ {c.max_slots}</span>
                  </dd>
                </div>
              </div>
            </dl>
