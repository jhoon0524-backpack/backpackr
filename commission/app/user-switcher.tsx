...
export async function UserSwitcher() {
  ...
  return (
    ...
    */
    <form action={switchUser} className="flex h-9 items-center gap-3">
      <span className="num text-[12px] font-bold tracking-[0.16em] text-white/40">시연용</span>
      <select
        name="userId"
      ...
      <button type="submit" className="h-full text-[15px] font-bold text-white/60 hover:text-white">
        바꾸기
      </button>
    </form>
  )
