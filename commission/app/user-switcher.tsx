...
export async function UserSwitcher() {
  ...
  return (
    <form action={switchUser} className="flex items-center overflow-hidden rounded-full border border-ink">
      <select
        name="userId"
      ...
      <button type="submit" className="h-9 border-l border-ink px-3 text-[13px] font-semibold text-ink hover:bg-fill">
        전환
      </button>
    </form>
  )
