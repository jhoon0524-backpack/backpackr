...
export function StuckForm({ auctionId }: { auctionId: string }) {
  ...
  return (
    <form action={action} className="mt-3 flex items-center gap-3 border-t border-zinc-100 pt-3">
      ...
      <span className="text-xs text-zinc-500">결제할 상대가 없어 유찰이 유일한 결말입니다.</span>
      {state && (
