...
export function SellForm() {
  ...
  return (
    <form action={action} className="mt-5 space-y-4 rounded-lg bg-white shadow-card px-5 py-5">
      ...
      */}
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-full rounded bg-ash px-4 py-2.5 text-sm font-medium text-white disabled:bg-faint"
      >
        {pending ? '등록 중…' : '검수 신청'}
      </button>
