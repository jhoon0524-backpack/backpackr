  ...
  return (
    <form action={action} className="mt-2 flex flex-wrap items-start gap-2">
      <input
        ...
        className="min-h-11 w-44 rounded border border-line px-3 text-sm tabular-nums"
      />
      <button
        type="submit"
        disabled={pending}
        className="inline-flex min-h-11 items-center rounded bg-ash px-4 text-sm text-white disabled:bg-faint"
      >
